 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="leadfollow" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "leadfollow";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "leadfollow") + "_chat_session";
