...
const howToSteps = [
  { name: 'Open LeadFollow', text: 'Go to the workspace and enter the inputs LeadFollow asks for.' },
  { name: 'Generate the draft', text: 'Run LeadFollow to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "LeadFollow writes warm, stage-aware follow-up emails after a showing, an open-house thank-you, or a long-term…"
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">LeadFollow writes warm, stage-aware follow-up emails after a showing, an open-house thank-you, or a long-term…</p>
