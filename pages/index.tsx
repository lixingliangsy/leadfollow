  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://leadfollow.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is LeadFollow?", "acceptedAnswer": {"@type": "Answer", "text": "LeadFollow generates stage-aware follow-up emails after showings, open houses, or for long-term nurture."}}, {"@type": "Question", "name": "Which stages does it cover?", "acceptedAnswer": {"@type": "Answer", "text": "Post-showing, open-house thank-you, and long-term nurture notes."}}, {"@type": "Question", "name": "Can I pick the tone?", "acceptedAnswer": {"@type": "Answer", "text": "It offers warm or professional tone with a no-pressure close."}}, {"@type": "Question", "name": "Does it suggest a next step?", "acceptedAnswer": {"@type": "Answer", "text": "Each note includes a clear next step for the reader."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Agents who want consistent follow-up without writing each note by hand."}}, {"@type": "Question", "name": "Is the copy ready to send?", "acceptedAnswer": {"@type": "Answer", "text": "The copy is ready to review and send."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">LeadFollow - definition</h2>
