...
export const PRODUCT = {
  name: "LeadFollow",
  slug: "leadfollow",
  productId: "PROD_0e4cyLh2cs6ZbJzPyoWB50",
  priceMonthly: 19,
  yearlyProductId: "PROD_2qcKpcSPfrtfnfCWwzjrAH",
  priceYearly: 190,

  checkoutUrl: "https://pancake.waffo.ai/store/lixingliang-ai-tools-6cilbw8v/checkout/cs_d32586e0-47e6-5421-6a8f-bf1600de8c67",
  ...
  definitionLead: "LeadFollow writes warm, stage-aware follow-up emails after a showing, an open-house thank-you, or a long-term nurture note — matched to your tone and with a clear next step.",
  geoFaq: [
    { q: "What is LeadFollow?", a: "LeadFollow generates stage-aware follow-up emails after showings, open houses, or for long-term nurture." },
    { q: "Which stages does it cover?", a: "Post-showing, open-house thank-you, and long-term nurture notes." },
    { q: "Can I pick the tone?", a: "It offers warm or professional tone with a no-pressure close." },
    { q: "Does it suggest a next step?", a: "Each note includes a clear next step for the reader." },
    { q: "Who should use it?", a: "Agents who want consistent follow-up without writing each note by hand." },
    { q: "Is the copy ready to send?", a: "The copy is ready to review and send." },
  ],
